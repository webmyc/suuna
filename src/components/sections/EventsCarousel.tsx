      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-16">
          ...
          <div className="hidden md:flex gap-3">
            <button
              ...
              className="w-14 h-14 rounded-[20px] bg-white border-2 border-sage/20 flex items-center justify-center transition-all hover:scale-105 hover:border-sage/40 hover:bg-sage/5 disabled:opacity-30 disabled:hover:scale-100 shadow-lg shadow-sage/10"
            ...
            {events.map((event) => {
              ...
              return (
                <div key={event.id} className="embla__slide">
                  <article className="bg-white/95 backdrop-blur-sm rounded-[32px] overflow-hidden shadow-2xl shadow-sage/15 hover:shadow-2xl hover:shadow-sage/25 transition-all duration-500 hover:-translate-y-2 group h-full flex flex-col">
                    {event.image && (
                      <div className="relative aspect-[16/9] overflow-hidden">
                        ...
                        {event.price && (
                          <div className="absolute top-5 right-5">
                            <span className="px-4 py-2 rounded-[16px] bg-terracotta text-white text-base font-semibold shadow-xl shadow-terracotta/30">
                              {event.price}
                            </span>
                          </div>
                        )}
                    ...
                    <div className="p-8 flex-1 flex flex-col">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-br from-sage to-forest text-white font-semibold text-base rounded-[20px] transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-sage/40 mt-auto group/button"
                      >
        ...
        <div className="flex md:hidden justify-center gap-3 mt-10">
          <button
            onClick={scrollPrev}
            disabled={!canScrollPrev}
            className="w-14 h-14 rounded-[20px] bg-white border-2 border-sage/20 flex items-center justify-center transition-all hover:scale-105 hover:border-sage/40 hover:bg-sage/5 disabled:opacity-30 shadow-lg shadow-sage/10"
            aria-label="Previous slide"
          >
            <ChevronLeft className="w-6 h-6 text-sage" />
          </button>
